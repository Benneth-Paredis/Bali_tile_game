...
public class Main : Spatial
{
    ...
    Tile_selection_menu tile_selction_menu;
    ...
    public override void _Ready()
    {
        ...
        tile_selction_menu = GetNode<Tile_selection_menu>("Tile_selection_menu");
        // display start
        display_updated_score();
        display_tile_selection_menu();
    }
    ...
    public void display_tile_selection_menu()
    {
        for (int i = 0; i < 3; i++)
        {
            Button button = GetNode<Button>("Tile_selection_menu/VBoxContainer/" + i);
